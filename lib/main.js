...
//Начала расчёта для каждой из версии
function master() {
...
//Вывод весовых коэфицентов на страницу
   ...
   {
      tmpCont += "<tr><th>" + criteries[i] + "</th><td>" + vesovoi_koef[i] + "</td></tr>";
   }
   tmpCont += "</table>";
...
//Вывод механизма доминирования
   ...
   for (var i = 0; i < criteries.length; i++)
   {
      tmpCont += "<tr><th>" + criteries[i] + "</th><td>" + names_firms[tmpar[i]] + "</td></tr>";
   }
   tmpCont += "</table>";
...
//Вывод суммы из турнирной таблицы помноженой на весовой коэфицент
   ...
   for (var i = 0; i < names_firms.length; i++)
   {
      tmpCont += "<tr><th>" + names_firms[i] + "</th><td>" + tmpar[i] + "</td></tr>";
   }
   tmpCont += "</table>";
